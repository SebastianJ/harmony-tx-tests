...
echo "The tests can be run on multiple networks - testnet is just used as an example. To run the framework on other networks, e.g. localnet, use --network localnet"
echo ""
